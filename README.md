...
- **Track library browser** loaded from a precomputed manifest (~770 tracks across 14 games). Sortable columns: title, game, BPM, key, meter, tags, length. Filter by game; search by title.
...
- 774 tracks across 14 games. Sortable columns:
  - **title**, **game**, **bpm**, **key**, **meter**, **tags**, **len**
